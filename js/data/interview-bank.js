  ...
  B.push(
    {
      ...
      keywords: ['name', 'years old|age', 'graduated|university|college|degree', 'study|major|studied', 'experience|worked|job|work in', 'personality|friendly|hard-working|cheerful|careful|patient|positive|people said|people describe', 'passion|dream|love|chance|hope|goal', 'customer|service|people'],
      follow: {
    ...
    },
    {
      ...
      keywords: ['friendly|cheerful|kind|warm', 'patient|calm', 'responsible|reliable', 'careful|detail|attentive', 'positive|optimistic|energetic', 'because|since|as', 'example|for instance|one time|once'],
      follow: {
    ...
    },
    {
      ...
      keywords: ['passion|love|dream|goal', 'service|serve|care|help', 'travel|places|world|new people', 'people|passenger', 'challenge|pressure|grow|professional', 'dream|since i was|always wanted', 'care|taking care|look after'],
      follow: {
    ...
    },
    {
      ...
      keywords: ['brand|reputation|image|famous', 'young|growing|fast|dynamic', 'professional|quality', 'growth|opportunity|develop|career', 'route|network|destination', 'service|crew|staff', 'values|culture|environment', 'proud|represent|part of'],
    ...
    },
    {
      ...
      keywords: ['communication|communicate|listen', 'calm|pressure|stress', 'service|customer', 'example|when|one time|last', 'team|colleague', 'language|english'],
    ...
    },
    {
      ...
      keywords: ['improve|improving|fix|overcome|working on', 'learning|learn', 'practice|plan|planning', 'better|progress|organized', 'feedback|advice|manager|noticed'],
    ...
    },
    {
      ...
      keywords: ['service|customer', 'experience|worked|handled', 'attitude|mindset|passion', 'learn|fast|quickly', 'team|teamwork', 'passenger|people', 'safety|safe|procedure'],
    ...
    },
    {
      ...
      keywords: ['safety|safe', 'first|priority|main|most important', 'security|secure', 'emergency|evacuation|fire|decompression', 'service|meal|food', 'procedure|check|demonstrate|equipment', 'passenger', 'comfort|care|welcome'],
    ...
    },
    {
      ...
      keywords: ['senior|experienced', 'purser|leader|instructor|manager', 'experience|master', 'grow|develop|improve', 'train|mentor|teach|help new', 'improve|language|skill'],
    ...
    },
    {
      ...
      keywords: ['understand|know|aware|discussed', 'family|parents|home', 'support|agree|encouraged', 'prepared|ready|used to|lived away', 'balance|manage|take care of myself', 'call|video|keep in touch|contact|visit'],
    ...
    },
    {
      ...
      keywords: ['professional|professionalism', 'first impression|impression', 'trust|confidence|confident', 'uniform|grooming|neat|appearance', 'standard|requirement|represent', 'represent|face|image|airline'],
    ...
    },
    {
      ...
      keywords: ['practice|practise|improve', 'every day|daily|routine|little', 'listening|listen|podcast', 'speaking|speak|club|conversation', 'app|application|vocabulary', 'movies|film|music|shadow|read', 'course|class|teacher'],
  ...
  B.push(
    {
      ...
      keywords: ['enjoy|love|like', 'relax|relaxing|relaxes', 'because|since|it makes', 'friends|family|people', 'learn|improve|skill|club', 'health|healthy|energy|fit|exercise'],
      follow: {
    ...
    },
    {
      ...
      keywords: ['breathe|breath|breathing', 'calm|relax|slow down', 'exercise|jogging|run|sport|gym|yoga', 'plan|prioritize|list|step|break the problem', 'positive|remind|mindset', 'talk|share|friend|family', 'rest|sleep|recharge'],
    ...
    },
    {
      ...
      keywords: ['team|group', 'communicate|communication|share|talk', 'support|help|cover', 'share|information|early', 'flexible|both|depends', 'together|cooperate|crew'],
    ...
    },
    {
      ...
      keywords: ['listen|hear them', 'thank|appreciate|grateful', 'improve|fix|change|correct', 'calm|not personal|personally|without interrupt', 'feedback|criticism|comment', 'learn|lesson|useful'],
    ...
    },
    {
      ...
      keywords: ['explore|discover|wander', 'food|eat|taste|street|dish', 'local|locals', 'walk|walking|on foot', 'museum|landmark|famous|viewpoint', 'people|talk|ask', 'plan|start|early|morning'],
    ...
    },
    {
      ...
      keywords: ['listen|heard|hear', 'respect|respected', 'understand|understood|their side', 'communicate|talk|asked|ask', 'compromise|solution|together|work it out', 'result|better|easier|improved'],
    ...
    },
    {
      ...
      keywords: ['morning|wake|get up', 'work|shift|job', 'study|english|review|learn', 'exercise|gym|jog|run|workout', 'evening|night|bed', 'prepare|plan|organize|ready'],
    ...
    },
    {
      ...
      keywords: ['listen|hear', 'anticipate|before they ask|notice|noticing|signal', 'smile|friendly', 'respect|polite|politeness', 'solve|solution|fix|problem', 'exceed|extra|beyond|more than', 'need|needs'],
      follow: {
    ...
    },
    {
      ...
      keywords: ['safety|safe', 'trained|training|study', 'emergency|evacuation|fire', 'first aid', 'professional|professionals', 'respect|responsible|responsibility', 'proud|pride|save'],
    ...
    },
    {
      ...
      keywords: ['mistake|failed|failure|wrong|missed', 'learned|learn|lesson', 'improve|changed|never|since then', 'responsibility|own|apologized|apologize', 'changed|different|now i', 'result|customer stayed|better'],
  ...
  B.push(
    {
      ...
      keywords: ['calm|calmly', 'listen|understand|hear', 'reason|why|frustration|frustrated', 'politely|polite|respect', 'solution|solve|offer', 'crew|colleague|senior|purser', 'report|inform|alert', 'captain|pilot', 'safety|safe|other passengers'],
      follow: {
    ...
    },
    {
      ...
      keywords: ['boarding pass|ticket|boarding card', 'check|verify|look at|see', 'calm|calmly|polite', 'apologize|sorry', 'alternative|another seat|reseat|equivalent|other seat', 'politely|respect|greet', 'both|two passengers'],
    ...
    },
    {
      ...
      keywords: ['first aid', 'check|assess|responsive|responsiveness', 'breathing|pulse|vital', 'crew|colleague|purser', 'announce|announcement|on board', 'doctor|medical professional|nurse', 'captain|pilot|divert', 'oxygen', 'calm|reassure|monitor'],
      follow: {
    ...
    },
    {
      ...
      keywords: ['secure|lock|put away', 'stop|pause|suspend', 'seatbelt|fasten|belt', 'announce|instruct|inform|tell', 'trolley|cart|hot drink|hot liquid', 'seat|seats|sit down|return', 'calm|voice|reassure', 'instruction|guide|verbal'],
    ...
    },
    {
      ...
      keywords: ['reassure|comfort|okay|safe', 'talk|explain|introduce', 'explain|normal|sound|noise', 'breathe|breathing|breath', 'normal|common|usual', 'check|visit|regularly|come back', 'smile|kneel|eye level|gentle', 'water|drink|tea'],
    ...
    },
    {
      ...
      keywords: ['refuse|stop serving|no more|decline|not serve', 'politely|polite|soft', 'water|juice|coffee|tea', 'food|snack|meal', 'explain|reason|comfort', 'safety|regulation|allowed', 'crew|colleague|inform|tell', 'monitor|watch|observe|keep an eye'],
    ...
    },
    {
      ...
      keywords: ['help|assist|support', 'parent|mother|father|mom|dad', 'offer|bring|suggest', 'warm|milk|bottle|water', 'walk|galley|carry', 'apologize|sorry|understand', 'empathy|stress|stressed|tired', 'passengers|earplugs|seat change|move'],
    ...
    },
    {
      ...
      keywords: ['apologize|sorry', 'sincere|sincerely|genuine|honest', 'alternative|other|option|choice|choose', 'offer|present|give', 'explain|reason|cause', 'compensate|voucher|extra|snack', 'report|inform|ground|note', 'follow up|check again|check on|come back'],
    ...
    },
    {
      ...
      keywords: ['explain|reason|why', 'politely|polite|respectful', 'safety|protect|safe', 'regulation|law|rule|require', 'senior|crew|purser', 'report|captain|inform', 'firm|firmly|cannot|will not'],
    ...
    },
    {
      ...
      keywords: ['check|inspect|open', 'fire|smoke|smoldering', 'smoke detector|detector|lavatory|toilet', 'report|inform|alert', 'extinguisher', 'captain|purser|pilot', 'regulation|law|violation|illegal|forbidden', 'safety|trash|bin|waste'],
    ...
    },
    {
      ...
      keywords: ['gesture|gestures|body language|point', 'smile|friendly', 'picture|pictures|menu|card|show', 'patient|patience|slowly|simple', 'translate|translation|app', 'crew|colleague|speaks|speak their'],
    ...
    },
    {
      ...
      keywords: ['calm|calmly|smile', 'apologize|sorry', 'name|my name', 'listen|hear|without interrupt', 'fix|solve|immediately|right away', 'professional|service recovery|purser', 'not personal|personally|stress|stressed'],
    ...
    },
    {
      ...
      keywords: ['safety|safe', 'remind|tell|speak|talk to', 'directly|direct|myself', 'report|inform', 'senior|purser|supervisor', 'procedure|check|step', 'never|always|must', 'compromise|risk|danger|lives'],
    ...
    },
    {
      ...
      keywords: ['command|commands|shout|order', 'shout|loud|clear|short', 'door|exit', 'assess|check|look', 'outside|condition|fire|obstacle', 'slide|jump', 'leave everything|leave belongings|no bags|leave your', 'fast|quick|speed|hurry', 'assist|help|elderly|children|disabled'],
  ...
  B.push(
    {
      ...
      keywords: ['situation|when|one day|worked at', 'customer|client|guest', 'action|i decided|i took|i made|myself|remade', 'listened|listen|heard', 'apologized|apologize|sorry|ownership', 'result|thanked|returned|came back|happy'],
    ...
    },
    {
      ...
      keywords: ['when|during|last year|one time', 'deadline|pressure|busy|rush|short-staffed|alone', 'prioritize|priority|order|urgent first', 'calm|steady|focus', 'plan|organized|step|asked for help', 'result|finished|success|achieved|highest'],
    ...
    },
    {
      ...
      keywords: ['team|group|we', 'project|task|assignment|presentation', 'role|coordinator|leader|my part|my job', 'communicate|check-in|meeting|discuss', 'together|shared|split|divide', 'support|helped|covered|backup', 'result|success|scored|won|highest'],
    ...
    },
    {
      ...
      keywords: ['noticed|saw|realized', 'extra|beyond|break|my own time|not my job', 'helped|help|taught|spent', 'time|hour|break', 'result|grateful|thank|came back'],
    ...
    },
    {
      ...
      keywords: ['disagreed|conflict|argument|tension', 'talked|talk|invited|conversation', 'directly|face to face|coffee|in person', 'listened|listen|hear her|hear his', 'understood|understand|her side|his side', 'compromise|solution|together|agreed', 'result|resolved|better|disappeared'],
    ...
    },
    {
      ...
      keywords: ['situation|when|suddenly|one day', 'decided|decision|decide', 'quickly|fast|in seconds|immediately', 'responsibility|ownership|myself|on my own', 'informed|report|called|told', 'result|no one|zero|safe|nothing lost'],
    ...
    },
    {
      ...
      keywords: ['changed|change|new|switched', 'suddenly|overnight|no warning|no training', 'adjusted|adapted|learned|tested|tried', 'flexible|open|embrace', 'learned|practice|cheat sheet|figured out', 'result|faster|better|smooth'],
    ...
    },
    {
      ...
      keywords: ['complaint|complained|complain', 'my mistake|i was wrong|she was right|he was right|it stung', 'apologized|apologize|sorry', 'listened|listen|asked', 'changed|improved|since then|now i', 'improved|better|rating', 'result|coach|learned'],
